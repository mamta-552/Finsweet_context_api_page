...
import white_house from "../assets/Png/white_house.png"
...
import Featured_in from "../assets/Png/Featured_in.png"
import Logo_1 from "../assets/Png/Logo_1.png"
import Logo_2 from "../assets/Png/Logo_2.png"
import Logo_3 from "../assets/Png/Logo_3.png"
import Logo_4 from "../assets/Png/Logo_4.png"
import Logo_5 from "../assets/Png/Logo_5.png"
import picture from "../assets/Png/picture.png"
import { maincontext } from "./Index";
const Home = () => {
  const { Author_cards } = maincontext()
  return <>

    {/* herosection */}

    <div className="herosection_bgi">``
      <div className="max-w-[1280px] px-3 mx-auto ">

        <div className="min-h-screen flex flex-col  justify-center">
          <div className=" text-center sm:text-start">
            <p className="font_inter font-semibold text-[16px] leading-[20px] tracking-[3px] text-white ">
              Posted on <span className="font-extrabold">startup</span>
            </p>
            <p className="font_sen font-bold  xl:text-[56px] lg:text-[45px] md:text-[38px] text-[30px] lg:leading-[64px] tracking-[-2px] text-white lg:w-[70%] lg:mt-[24px] mt-[18px]">
              Step-by-step guide to choosing great font pairs
            </p>
            <p className=" font_inter font-normal text-[16px] leading-[28px] lg:mt-[24px] mt-[17px] text-white">
              By <span className="text-[#FFD050]">James West</span>  |  May 23, 2022
            </p>
            <p className="font_inter font-normal text-[16px] leading-[28px] text-[white] mt-[16px] lg:w-[48%]">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.
            </p>
            <div>
              <button className="text-[#232 536] font_sen font-bold text-[18px] leading-[24px] lg:mt-[48px] mt-[25px] bg-[#FFD050] py-[16px] px-[48px] ">
                Read More
              </button>
            </div>
          </div>
    ...
    <div className="max-w-[1280px] px-3 mx-auto xl:mt-[128px] lg:mt-[100px] md:mt-[70px] mt-[40px]">
      <div className="flex flex-row flex-wrap lg:justify-between lg:items-center justify-center">

        <div className="lg:w-7/12 px-3 md:w-9/12 sm:w-11/12 w-12/12">
          <p className="font_sen font-bold  lg:text-[36px] sm:text-[29] text-[24px] lg:leading-[48px] tracking-[-2px] text-[#232536]">Featured Post</p>
          <div className="br_1_grey mt-[32px] lg:p-[32px] p-[20px]">
            <img src={white_house} alt="house img" />
            <p className="font_inter font-medium text-[14px] leading-[20px] text-[#4C4C4C] mt-[32px]">
              By <span className="text-[#592EA9]">John Doe </span>  l   May 23, 2022
            </p>
            <p className="font_sen font-bold lg:text-[28px] md:text-[25px] text-[19px] lg:leading-[40px] tracking-[-1px] mt-[16px]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.
            </p>
            <p className="font_inter text-[16px] mt-[16px] font-normal leading-[28px] text-[#6D6E76]">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.
            </p>
        ...
        <div className="lg:w-5/12 px-3 md:w-10/12 mt-[30px] lg:mt-[0] sm:w-11/12 w-12/12">
          <div className="flex items-center justify-between">
            <p className="font_sen font-bold lg:text-[36px] sm:text-[29] text-[24px]  leading-[48px] tracking-[-2px] text-[#232536]">
              All Posts
            </p>
            <p className="font_inter font-normal text-[16px] cursor-pointer leading-[28px] text-[#592EA9]">
              View All
            </p>
          </div>

          <div className="lg:mt-[32px] md:mt-[25px] hover:bg-[#FBF6EA] duration-500 pt-[26px] pb-[25px] xl:pe-[116px] ps-[32px]">
            <p className="font_inter font-medium text-[14px] leading-[20px]  text-[#4C4C4C] ">
              By <span className="text-[#592EA9]">John Deo </span>  l   Aug 23, 2021
            </p>
            <p className="font_sen fott-bold lg:text-[24px] md:text-[20px] text-[18px] lg:leading-[32px] text-[#232536] mt-[8px]">
              8 Figma design systems that you can download for free today.
            </p>
          </div>

          <div className=" hover:bg-[#FBF6EA] duration-500 pt-[26px] pb-[25px] xl:pe-[116px] ps-[32px]">
            <p className="font_inter font-medium text-[14px] leading-[20px]  text-[#4C4C4C] ">
              By <span className="text-[#592EA9]">John Deo </span>  l   Aug 23, 2021
            </p>
            <p className="font_sen fott-bold lg:text-[24px] md:text-[20px] text-[18px] lg:leading-[32px] text-[#232536] mt-[8px]">
    ...
    <div className="max-w-[1280px] px-3 mx-auto lg:mt-[128px] md:mt-[90px] mt-[50px]">
      <div className="bg-[#F4F0F8] lg:py-[96px] py-[50px] lg:ps-[80px] lg:pe-[108px] px-[40px]">
        <div className="flex flex-row flex-wrap justify-between">
          <div className="lg:w-6/12 px-3 ">
            ...
            <p className="font_sen  font-bold lg:text-[36px] md:text-[28px] text-[25px] lg:leading-[48px] tracking-[-2px] mt-[24px] text-[#232536]">
              We are a community of content writers who share their learnings
            </p>

            <p className="font_inter font-normal text-[16px] leading-[28px] mt-[16px] text-[#6D6E76]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
            <button className="font_sen font-bold text-[18px] leading-[32px] text-[#592EA9] mt-[16px]">Read More </button>
          </div>

          <div className="lg:w-5/12 px-3 mt-[30px] lg:mt-[0]">
            <p className="font_inter font-semibold text-[16px] lg:leading-[20px] tracking-[3px] text-[#232536]">
              OUR MISION
            </p>
            <p className="font_sen  font-bold md:text-[28px] text-[25px] lg:leading-[40px] tracking-[-1px] mt-[24px] text-[#232536]">
    ...
    <div className="max-w-[1280px] px-3 mx-auto  lg:mt-[128px] md:mt-[100px] mt-[50px]">
      <p className="font_sen font-bold lg:text-[36px] text-[28px]  lg:leading-[36px] tracking-[-2px] text-[#232536] text-center">
        Choose A Catagory
      </p>
    ...
    {/* images section */}
    <div className="max-w-[1280px]  px-9 mx-auto mt-[76px]  hidden lg:block">
      <div className="flex justify-between items-center  ">
        <div className="me-[70px]"><img src={Featured_in} alt="img" /></div>
        <div className="me-[70px]"><img src={Logo_1} alt="img" /></div>
        <div className="me-[70px]"><img src={Logo_2} alt="img" /></div>
        <div className="me-[70px]"><img src={Logo_3} alt="img" /></div>
        <div className="me-[70px]"><img src={Logo_4} alt="img" /></div>
        <div ><img src={Logo_5} alt="img" /></div>
      </div>
    </div>

    {/* TESTIMONIALs */}
    <div className="max-w-[1280px]  px-9 mx-auto lg:mt-[96px] md:mt-[70px] mt-[50px]">
      <div className="bg-[#FBF6EA] lg:p-[70px] md:p-[40px] p-[20px]">
        <div className="flex flex-wrap flex-row justify-between">
          <div className="lg:w-4/12 px-3">
            <p className="font_inter font-semibold text-[16px] leading-[20px] tracking-[3px] text-[#232536]">
              TESTIMONIALs
            </p>
            <p className="font_sen font-semibold lg:text-[36px] text-[28px] lg:leading-[48px] tracking-[-2px] text-[#232536] mt-[12px]">
              What people say about our blog
            </p>
            <p className="font_inter font-normal text-[16px] leading-[28px] text-[#232536] lg:mt-[16px] mt-[10px]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.
            </p>
          </div>
          <div className="w-1/12 px-3 hidden lg:block">
            <div className="h-[310px] w-[0.6px] bg-[#6D6E76]"></div>
          </div>

          <div className="lg:w-5/12 px-3 mt-[30px] lg:mt-[0]">
            <p className="font_sen font-bold lg:text-[24px] text-[21px] lg:leading-[32px] text-[#232536]">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
            <div className="md:flex  items-center lg:mt-[90px] mt-[20px]">
              <div><img className="me-[16px]" src={picture} alt="img" /></div>
              <div>
                <p className="font_sen font-bold sm:text-[24px] text-[20px] leading-[32px] text-[#232536]">
                  Jonathan Vallem
                </p>
                <p className="font_inter font-normal text-[16px] leading-[28px] text-[#6D6E76]">
                  New york, USA
                </p>
              </div>
            </div>
